    ...
    <nav className='w-full bg-[#05051B]'>
      ...
      <div className='max-w-7xl mx-auto flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8'>
        ...
        <div className='hidden md:block'>
          <button className='px-4 py-2 bg-[#A99AD3] text-[#05051B] font-semibold rounded-lg hover:bg-gray-300 transition cursor-pointer'>
            Login / Sign Up
          </button>
        </div>
      ...
      {isOpen && (
        <div className='md:hidden bg-[#05051B] px-4 pb-4 space-y-3'>
          ...
          <button className='cursor-pointer w-full mt-2 px-4 py-2 bg-[#A99AD3] text-[#05051B] font-semibold rounded-lg hover:bg-gray-300 transition'>
            Login / Sign Up
          </button>
